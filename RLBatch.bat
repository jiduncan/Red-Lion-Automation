...
echo %time% entered begin
echo %time% entered begin >> "C:\Users\johnny\Dropbox\RL_Logs\batch_Logs\%myDate%.txt"
...
echo %time% entered runit >> "C:\Users\johnny\Dropbox\RL_Logs\batch_Logs\%myDate%.txt"
...
echo %time% entered lock >> "C:\Users\johnny\Dropbox\RL_Logs\batch_Logs\%myDate%.txt"
...
echo %time% entered killit >> "C:\Users\johnny\Dropbox\RL_Logs\batch_Logs\%myDate%.txt"
...
echo %time% exiting program for the day >> "C:\Users\johnny\Dropbox\RL_Logs\batch_Logs\%myDate%.txt"
exit

:cont
echo %time% entered cont
echo %time% entered cont >> "C:\Users\johnny\Dropbox\RL_Logs\batch_Logs\%myDate%.txt"
timeout /t 60
goto begin

:shutDownNow
echo %time% turning off now
echo %time% turning off now >> "C:\Users\johnny\Dropbox\RL_Logs\batch_Logs\%myDate%.txt"
shutdown /s /f
